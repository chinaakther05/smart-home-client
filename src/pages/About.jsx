    ...
    <section className="bg-gradient-to-b from-gray-50 to-white py-12 md:py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-block bg-gradient-to-r from-[#DB995A] to-orange-400 p-1 rounded-full mb-6">
            <div className="bg-white rounded-full px-6 py-1">
              <span className="text-sm font-semibold text-gray-700">About Our Journey</span>
            </div>
          </div>
          
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            About <span className="text-green-600">SmartHome</span>
            <span className="text-[#DB995A]">Decor</span>
          </h1>
          
          <div className="max-w-3xl mx-auto">
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed bg-gradient-to-r from-gray-50 to-[#DB995A]/10 p-6 rounded-2xl border-l-4 border-green-500">
            ...
            <button
              ...
              className={`px-6 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 ${
                index === 0 
                  ...
                  : 'bg-white text-gray-600 hover:text-green-600 hover:bg-gray-50 border border-gray-200 hover:border-green-300'
              }`}
            >
              {tab}
            </button>
        ...
        <div className="relative mb-16">
          ...
          <div className="relative bg-white rounded-3xl shadow-xl p-8 md:p-12 lg:p-16">
            ...
            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              <p className="bg-gray-50 p-6 rounded-xl border-l-4 border-[#DB995A]">
              ...
              <p className="bg-gradient-to-r from-green-50 to-white p-6 rounded-xl border border-green-100">
                With <span className="font-bold text-green-600">SmartHome Decor</span>,
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {[
              { value: "5K+", label: "Happy Clients", color: "text-green-600" },
              { value: "1K+", label: "Events Completed", color: "text-[#DB995A]" },
              { value: "10+", label: "Years Experience", color: "text-green-600" },
              { value: "24/7", label: "Support", color: "text-[#DB995A]" }
            ].map((stat, index) => (
              <div 
                key={index}
                className="bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 hover:border-green-200"
              >
                <h4 className={`text-4xl md:text-5xl font-bold ${stat.color} mb-3`}>
                  {stat.value}
                </h4>
                <p className="text-gray-600 font-medium">{stat.label}</p>
                <div className={`h-1 w-16 mx-auto mt-4 rounded-full ${stat.color === 'text-green-600' ? 'bg-green-500' : 'bg-[#DB995A]'}`}></div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-3xl">
          ...
          <div className="relative p-10 md:p-14 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact"
                className="inline-flex items-center justify-center bg-white text-green-600 font-bold px-8 py-4 rounded-xl hover:bg-gray-50 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
