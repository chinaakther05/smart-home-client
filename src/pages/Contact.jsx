          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
              <div className="p-6 border-b border-gray-100">
                <h3 className="font-bold text-gray-800 text-xl">Visit Our Studio</h3>
                <p className="text-gray-600 mt-2">Come see our latest work and discuss your project</p>
              </div>
              <div className="h-64 bg-gradient-to-r from-green-100 to-[#DB995A]/20 flex items-center justify-center">
                <div className="text-center">
                  <MapPin className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                  <p className="text-gray-500">Studio Location Map</p>
            ...
            {/* Quick Stats */}
            <div className="bg-gradient-to-r from-green-600 to-[#DB995A] rounded-2xl p-8 text-white">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-green-100">Rated Service</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-2xl shadow border border-gray-100 hover:shadow-md transition">
                <h4 className="font-bold text-gray-800 text-lg mb-2">{faq.q}</h4>
